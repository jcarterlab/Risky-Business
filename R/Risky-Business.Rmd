...
This project uses web scraping, regex combinations and a labeling mechanism to identify political violence risks in the emerging world, as well as how their prevalence differs by continent and region. It uses `r nrow(data)` headlines from `r length(unique(data$Name))` local online newspapers.

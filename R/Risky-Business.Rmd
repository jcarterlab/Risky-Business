...
This project uses web scraping, regex and a labeling mechanism to uncover the relative prevelance of different violence risks in the emerging world. The results include `r nrow(data)` risk headlines from `r length(unique(data$Name))` different news sources. Just as Tom Cruise discovered in Risky Business, those seeking to venture into the unknown could find things get out of hand quickly if they're not careful. 
...
A database of over 250 online newspapers in the emerging world is assembled.  
